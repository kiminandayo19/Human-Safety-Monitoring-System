"""Person detection endpoints — run the person model over uploaded frames."""
...
async def detect_person(
    ...
    """Detect persons in a single uploaded image using the person model."""
    ...
    if save_detection:
        ...
        out_path = output_dir / f"{result.detection_id}.json"
